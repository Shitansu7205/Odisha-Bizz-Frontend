...
const ProductListingForm = () => {
    ...
    useEffect(() => {
        const fetchStates = async () => {
            try {
                const res = await fetch("https://www.india-location-hub.in/api/locations/states");
    ...
    const fetchDistricts = async (stateName) => {
        ...
        try {
            const res = await fetch(
                `https://www.india-location-hub.in/api/locations/districts?state=${encodeURIComponent(stateName)}`
            );
            const data = await res.json();
