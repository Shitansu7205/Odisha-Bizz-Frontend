...
export default function SearchForm() {
  ...
  return (
    <div className="flex items-center justify-around flex-row py-2 ">
      <div>
        <h1 className="text-xl md:text-2xl font-semibold text-gray-800 mb-4 text-center flex flex-wrap justify-center items-center gap-2">
          Search across{" "}
        ...
        <form
          onSubmit={handleSubmit}
          className="flex w-full max-w-3xl border border-gray-200 rounded-lg overflow-hidden shadow-md bg-white transition-all duration-300 hover:shadow-lg"
        >
          {/* District Selector */}
      ...
      <div>
        <p className="text-transparent"> hdiew</p>
      </div>
    </div>
  );
}
