...
function FeatureCard({ title, desc, icon, delay }) {
  ...
  return (
    ...
    >
      <Card
        className={`bg-white shadow-md rounded-xl p-6 flex flex-col items-center text-center h-full border border-gray-200 transition-transform duration-300 ${
          hovered ? "shadow-xl" : ""
        }`}
      >
        <div
          className={`mb-4 flex items-center justify-center w-14 h-14 rounded-full bg-gray-100 transition-all duration-300 ${
